class Admin::UnitsController < ApplicationController
  ...
  def index
    ...
    respond_to do |format| 
            ...
            format.xlsx {render xlsx: "reports", template: "admin/units/reports.xlsx.axlsx"}
    end
  end
  ...
  private
    ...
    def unit_params
      params.require(:unit).permit(:name, :description, :abbreviation, :unit_key, :unit_description, :deleted_at)
    end
end