...
class AccessoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post accessories_url, params: { accessory: { deleted_at: @accessory.deleted_at, description: @accessory.description, name: @accessory.name } }
    end
  ...
  test "should update accessory" do
    patch accessory_url(@accessory), params: { accessory: { deleted_at: @accessory.deleted_at, description: @accessory.description, name: @accessory.name } }
