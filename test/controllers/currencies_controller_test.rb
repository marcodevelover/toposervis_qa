...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { abbreviation: @currency.abbreviation, deleted_at: @currency.deleted_at, description: @currency.description, name: @currency.name } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { abbreviation: @currency.abbreviation, deleted_at: @currency.deleted_at, description: @currency.description, name: @currency.name } }
