...
class Admin::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post admin_users_url, params: { admin_user: { deleted_at: @admin_user.deleted_at, lastname: @admin_user.lastname, name: @admin_user.name, phone: @admin_user.phone, role_id: @admin_user.role_id } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { deleted_at: @admin_user.deleted_at, lastname: @admin_user.lastname, name: @admin_user.name, phone: @admin_user.phone, role_id: @admin_user.role_id } }
