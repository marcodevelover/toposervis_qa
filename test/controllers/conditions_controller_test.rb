...
class ConditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post conditions_url, params: { condition: { default: @condition.default, deleted_at: @condition.deleted_at, description: @condition.description, name: @condition.name } }
    end
  ...
  test "should update condition" do
    patch condition_url(@condition), params: { condition: { default: @condition.default, deleted_at: @condition.deleted_at, description: @condition.description, name: @condition.name } }
