...
class CategoryTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create category_type" do
    assert_difference('CategoryType.count') do
      post category_types_url, params: { category_type: { deleted_at: @category_type.deleted_at, description: @category_type.description, name: @category_type.name } }
    end
  ...
  test "should update category_type" do
    patch category_type_url(@category_type), params: { category_type: { deleted_at: @category_type.deleted_at, description: @category_type.description, name: @category_type.name } }
