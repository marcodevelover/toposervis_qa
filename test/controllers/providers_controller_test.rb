...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference('Provider.count') do
      post providers_url, params: { provider: { business_name: @provider.business_name, name: @provider.name, rfc: @provider.rfc } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { business_name: @provider.business_name, name: @provider.name, rfc: @provider.rfc } }
